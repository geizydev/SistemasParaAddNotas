...
public class ViewAjuda extends JFrame{
	...
	public ViewAjuda(SistemaGeral objSistema) {
		...
		this.perguntaFrequente1 = new JLabel("1.Como faço para alterar minha senha? ");
		perguntaFrequente1.setBounds(100, 120, 300, 20);
		add(perguntaFrequente1);
		this.ajuda1Label = new JLabel("Para fazer qualquer tipo de alteração no sistema é necessário entrar em contato com o administrador.");
		ajuda1Label.setBounds(120, 140, 600, 20);
		add(ajuda1Label);
		
		this.perguntaFrequente2 = new JLabel("2.Onde posso encontrar o setor de administração?");
